...
(
       ...
       -- foreign KEYS
       EDAD_ID number(6),
       constraint FK_EDAD_B foreign key (EDAD_ID) references EDAD(EDAD_ID),
       ...
       CONSTRAINT FK_NACIONALIDAD_B FOREIGN KEY (NACIONALIDAD_ID) REFERENCES PAIS(PAIS_ID),
...
COMMENT ON COLUMN BUSCAR.BUSCAR_ID IS 'LLAVE PRIMARIA DE LA TABLA';
COMMENT ON COLUMN BUSCAR.PERSONA_ID IS 'LLAVE PRIMARIA DE PERSONA, FORANEA EN ESTA TABLA';
COMMENT ON COLUMN BUSCAR.EDAD_id IS 'EDAD A BUSCAR';
COMMENT ON COLUMN BUSCAR.GENERO IS 'GENERO A BUSCAR';
COMMENT ON COLUMN BUSCAR.AFINIDAD_MASCOTA IS 'AFINIDAD DE MASCOTAS DE PERSONA A BUSCAR';
COMMENT ON COLUMN BUSCAR.DISPONIBLE_MASCOTA IS 'DISPONIBILIDAD DE MASCOTAS DE PERSONA A BUSCAR';
COMMENT ON COLUMN BUSCAR.CANT_HIJOS IS 'CANTIDAD DE HIJOS QUE TIENE LA PERSONA A BUSCAR';
COMMENT ON COLUMN BUSCAR.QUIERE_HIJOS IS 'SI LA PERSONA A BUSCAR QUIERE HIJOS';

COMMENT ON COLUMN BUSCAR.EST_CIVIL_ID IS 'LLAVE FORANEA';
COMMENT ON COLUMN BUSCAR.CIUDAD_ID IS 'LLAVE FORANEA';
COMMENT ON COLUMN BUSCAR.NACIONALIDAD_ID IS 'LLAVE FORANEA';
COMMENT ON COLUMN BUSCAR.RELIGION_ID IS 'LLAVE FORANEA';
COMMENT ON COLUMN BUSCAR.ZODIACO_ID IS 'LLAVE FORANEA';
COMMENT ON COLUMN BUSCAR.ALTURA_ID IS 'LLAVE FORANEA';
COMMENT ON COLUMN BUSCAR.PESO_ID IS 'LLAVE FORANEA';
COMMENT ON COLUMN BUSCAR.CONTEXTURA_ID IS 'LLAVE FORANEA';
COMMENT ON COLUMN BUSCAR.CPIEL_ID IS 'LLAVE FORANEA';
COMMENT ON COLUMN BUSCAR.COJOS_ID IS 'LLAVE FORANEA';
COMMENT ON COLUMN BUSCAR.CCABELLO_ID IS 'LLAVE FORANEA';
COMMENT ON COLUMN BUSCAR.IDIOMA_ID IS 'LLAVE FORANEA';
COMMENT ON COLUMN BUSCAR.OCUPACION_ID IS 'LLAVE FORANEA';
COMMENT ON COLUMN BUSCAR.SALARIO_ID IS 'LLAVE FORANEA';
COMMENT ON COLUMN BUSCAR.ESCOLARIDAD_ID IS 'LLAVE FORANEA';

COMMENT ON COLUMN BUSCAR.FEC_CREACION IS 'CAMPO AUDITORIA';
COMMENT ON COLUMN BUSCAR.USUARIO_CREACION IS 'CAMPO AUDITORIA';
COMMENT ON COLUMN BUSCAR.FEC_ULTIMA_MODIFICACION IS 'CAMPO AUDITORIA';
COMMENT ON COLUMN BUSCAR.USUARIO_ULTIMA_MODIFICACION IS 'CAMPO AUDITORIA';
