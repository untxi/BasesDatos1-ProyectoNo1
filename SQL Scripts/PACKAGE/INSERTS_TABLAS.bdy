CREATE OR REPLACE PACKAGE BODY INSERTS_TABLAS IS
       ...
       PROCEDURE INSERTAR_TABLA_EMAIL_P(pEmail in varchar2, pPersona in number)
         AS
                 BEGIN
                   ...
                   VALUES(s_email_id.nextval, pEmail, pPersona);
                 END;
       ...
       PROCEDURE INSERTAR_TABLA_PERSONA(tipo_usuario_id in number, pNombre in varchar2, pPrimerApellido in varchar2, pSegundoApellido in varchar2,
         ...
         AS
                BEGIN
                  INSERT INTO PERSONA(PERSONA_ID,TIPO_USUARIO_ID,NOMBRE,PRIMER_APELLIDO,SEGUNDO_APELLIDO,
                                      NACIMIENTO,GENERO,FOTO,SLOGAN,AFINIDAD_MASCOTA,DISPONIBLE_MASCOTA,
                                      CANT_HIJOS,QUIERE_HIJOS,EST_CIVIL_ID,CIUDAD_ID,NACIONALIDAD_ID,RELIGION_ID,
                                      ZODIACO_ID,ALTURA_ID,PESO_ID,CONTEXTURA_ID,CPIEL_ID,COJOS_ID,CCABELLO_ID,
                                      OCUPACION_ID,SALARIO_ID,ESCOLARIDAD_ID)

                  VALUES(S_PERSONA_ID.NEXTVAL, tipo_usuario_id, pNombre, pPrimerApellido, pSegundoApellido,
                  pNacimiento, pGenero, pFoto,pSlogan, pAfinidad_Mascota, pDisponibilidad_Mascota, pCant_Hijos, 
                  pQuiere_Hijos, pEst_Civil, pCiudad, pNacionalidad,pReligion, pZodiaco, pAltura, pPeso, pContextura, 
                  pCPiel, pCOjos, pCCabello, pOcupacion, pSalario, pEscolaridad);
                end;
       ...
       PROCEDURE INSERTAR_TABLA_BUSCAR_P(pPersona in number, pEdad in NUMBER, pGenero in char, pAfinidad_Mascota in char,
         ...
         AS
                BEGIN
                  INSERT INTO BUSCAR(BUSCAR_ID,PERSONA_ID,EDAD_ID,GENERO,AFINIDAD_MASCOTA,DISPONIBLE_MASCOTA,CANT_HIJOS,QUIERE_HIJOS,
                  EST_CIVIL_ID, CIUDAD_ID,NACIONALIDAD_ID,RELIGION_ID,ZODIACO_ID, ALTURA_ID,PESO_ID,CONTEXTURA_ID,CPIEL_ID,COJOS_ID,CCABELLO_ID,
                  OCUPACION_ID,SALARIO_ID,ESCOLARIDAD_ID)
                  VALUES(S_BUSCAR_ID.NEXTVAL, pPersona,pEdad, pGenero,pAfinidad_Mascota, pDisponibilidad_Mascota, pCant_Hijos, pQuiere_Hijos,
                  pEst_Civil, pCiudad, pNacionalidad, pReligion, pZodiaco, pAltura, pPeso, pContextura, pCPiel, pCOjos, pCCabello, pOcupacion, pSalario,
                  pEscolaridad);
                end;
