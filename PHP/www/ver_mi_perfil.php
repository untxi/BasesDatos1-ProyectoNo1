...
<html>
	...
	<head>
		...
		<blockquote> 
				<blockquote>
					<font face="avenida" size=14>User</font>
				</blockquote>
				<TABLE align="center">
					<TR>
						<TD><font face="avenida" size=14>1 Match</font>
						</TD>
						
						<TD><font face="avenida" size=14>15 Winks</font>
						</TD>
						
						<TD><font face="avenida" size=14>37 Visitas</font>
						</TD>
						
						<TD>
							<a href="frame_editar_perfil.php">
							<div class="row"><th>
								<div class="12u">
									<ul class="actions">
...
<!--INFORMACION PERSONAL-->
			<div align="center">
				<img src="images/user.png" alt="" width="140" height="200"/>
			</div>
